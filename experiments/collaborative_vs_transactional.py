...
OUTPUT_DIR = Path("collab_trans_outputs")
PROMPT_VALIDATION_CSV = OUTPUT_DIR / "collab_trans_prompt_validation.csv"
NEXT_TOKEN_CSV = OUTPUT_DIR / "collab_trans_next_token_predictions.csv"
RESIDUAL_NORMS_CSV = OUTPUT_DIR / "collab_trans_residual_norms.csv"
METHOD_NOTES_MD = OUTPUT_DIR / "collab_trans_method_notes.md"
...
def write_method_notes(device, dtype):
    notes = f"""# Collaborative vs Transactional Framing Method Notes
